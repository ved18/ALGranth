...
<p style="font-size :25px;	">A sorting algorithm is an algorithm made up of a series of instructions that takes an array as input, performs specified operations on the array, sometimes called a list, and outputs a sorted array. Sorting algorithms are often taught early in computer science classes as they provide a straightforward way to introduce other key computer science topics like Big-O notation, divide-and-conquer methods, and data structures such as binary trees, and heaps.</p>
<hr>
<p style="font-size :25px;	">Sorting Algorithms Examples:</p>
<p style="font-size :25px;	">1.Bucket Sort</p>
<p style="font-size :25px;	">2.Selection Sort</p>
<p style="font-size :25px;	">3.Bubble Sort</p>
<p style="font-size :25px;	">4.Recursive Bubble Sort</p>
<p style="font-size :25px;	">5.Insertion Sort</p>
<p style="font-size :25px;	">6.Recursive Insertion Sort</p>
<p style="font-size :25px;	">7.Merge Sort</p>
<p style="font-size :25px;	">8.Iterative Merge Sort</p>
<p style="font-size :25px;	">9.Quick Sort</p>
<p style="font-size :25px;	">10.Iterative Quick Sort</p>
<p style="font-size :25px;	">11.Heap Sort</p>
<p style="font-size :25px;	">12.Counting Sort</p>
<p style="font-size :25px;	">13.Radix Sort</p>

<p style="font-size :25px;	">14.ShellSort</p>
